...
var SeleniumStandaloneLauncher = function () {
    ...
    _createClass(SeleniumStandaloneLauncher, [{
        ...
        value: function _redirectLogStream() {
            var logFile = _path2.default.join(process.cwd(), this.seleniumLogs);

            /**
             * create directory if not existing
             */
            try {
                _fs2.default.statSync(logFile);
            } catch (e) {
                _mkdirp2.default.sync(logFile);
            }
            ...
            var logStream = _fs2.default.createWriteStream(logFile, { flags: 'w' });
